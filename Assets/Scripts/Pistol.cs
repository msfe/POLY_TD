...
public class Pistol : MonoBehaviour {
	...
	private bool ATTACK_WHILE_MOVING = true;
	private float ATTACK_DOWNTIME = 50.0f;
	private float ATTACK_MOUNTTIME = 00.0f; 
	private float BULLET_SPREAD = 0.1f;
	private float BULLET_SPEED = 5.0f;
	private float BULLET_DAMAGE = 6.0f;
